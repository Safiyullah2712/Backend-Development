...
import com.student.management.cache.CacheEntry;
...
public class MessageService {
    ...
    CacheEntry<Page<MessageSearchDTO>>>
    pageCache =
    new HashMap<>();
